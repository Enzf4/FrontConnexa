              ...
              >
                ...
                {messages.length === 0 ? (
                  <div className="text-center py-5">
                    ...
                    <p className="text-muted">Seja o primeiro a enviar uma mensagem!</p>
                  </div>
                ) : (
                  <div className="p-3">
                      ...
                      return (
                        ...
                        >
                          <div className="d-flex align-items-start">
                            <img 
                              src={message.usuario_foto || '/default-avatar.png'} 
                              alt="Avatar" 
                              className="profile-pic me-2"
                              style={{ width: '32px', height: '32px' }}
                              onError={(e) => {
                                e.target.src = 'https://via.placeholder.com/32x32/6c757d/ffffff?text=' + message.usuario_nome.charAt(0).toUpperCase();
                              }}
                            />
                              ...
                              <div className="d-flex justify-content-between align-items-start mb-1">
                                <h6 className="mb-0 small">
                                  ...
                                  <small className="text-muted ms-2">
                                    {message.usuario_curso} • {message.usuario_periodo}
                                  </small>
                                </h6>
                                <small className="text-muted">
